...
Como prerequisito é necessário ter uma IDE instalada.
...
Observações:
```
1. Este material pode ser usado como suporte às disciplinas de: lógica, algoritmos, programação e projeto de sistemas.
